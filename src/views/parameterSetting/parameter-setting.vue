                    ...
                    <div class="container">
                        <div class="btn-left w18">
                            <Form-item prop="brandId">
                                <Input placeholder="请输入参数名称" v-model.trim="formData.articleName" clearable></Input>
                            </Form-item>
                        </div>
            ...
            <div slot="main" class="modal-main">
                ...
                <div class="modal-table">
                    <Form ref="form" class="model-form" :label-width="88">
                        <Form-item label="参数类型:" v-if="type == 'add'" required>
                            <Select v-model="addData.brandId" placeholder="请选择参数类型" clearable>
                        ...
                        <Form-item label="描述:" required>
                            <Input clearable type="textarea" :rows="5" v-model.trim="addData.articleName" placeholder="限50个字符以内"></Input>
                        </Form-item>
