          ...
          <div class="container">
            <div class="btn-left w18">
              <Form-item prop="brandId">
                <Input placeholder="请输入企业名称" v-model="formData.name" clearable/>
              </Form-item>
            </div>
          </div>
        ...
        <div class="modal-table">
          <Form ref="form" class="model-form" :label-width="88">
            <Form-item label="企业名称:" required>
              <Input clearable v-model.trim="addData.name" placeholder="限50个字符以内"/>
            </Form-item>
            <Form-item label="备注信息:">
              <Input clearable v-model.trim="addData.memo" placeholder="限英255个字符以内"/>
            </Form-item>
          </Form>
        </div>
        <div class="footer">
...
export default {
  ...
  methods: {
    save() {
      ...
      if (this.addData.name.length > 50) {
        this.$Message.info("企业名称过长");
        return false;
      }
      ...
      if (this.type == "modify") {
        ...
        api = "company/doUpdate.json";
      } else {
        api = "company/doSave.json";
      }
    ...
    init() {
      ...
      data["status"] = 1;
      this.Global.doPost("company/doQueryWithPage.json", data, res => {
