          ...
          <div class="box canvas-box">
            <div class="left-box">
              ...
              <div class="right">
                ...
                <div class="fun-box" >
                  <img @click="startLabel('rotate')" src="@/assets/image/light.png">
                  <div class="light-box" v-if="showRotate">
                    <Slider v-model="imgSelected.rotate" :step="0.1" :min="0" :max="360" @on-change.self="rotateImg"></Slider>
                  </div>
                </div>
                <div class="fun-box" >
...
export default {
  ...
  methods: {
    ...
    rotateImage(src, angle = 0) {
      if (angle === 0) {
        this.imgSelected.src = src;
        this.mount();
      } else {
        let index = this.getImageIndex();
